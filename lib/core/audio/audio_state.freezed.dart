...
mixin _$AudioState {
 ...
 PlaybackStatus get status; double get volume; int get quality; String? get currentTitle; String? get currentArtist; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,volume,quality,currentTitle,currentArtist,errorMessage);

@override
String toString() {
  return 'AudioState(status: $status, volume: $volume, quality: $quality, currentTitle: $currentTitle, currentArtist: $currentArtist, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 PlaybackStatus status, double volume, int quality, String? currentTitle, String? currentArtist, String? errorMessage
});
...
/// Create a copy of AudioState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? volume = null,Object? quality = null,Object? currentTitle = freezed,Object? currentArtist = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PlaybackStatus status,  double volume,  int quality,  String? currentTitle,  String? currentArtist,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AudioState() when $default != null:
return $default(_that.status,_that.volume,_that.quality,_that.currentTitle,_that.currentArtist,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PlaybackStatus status,  double volume,  int quality,  String? currentTitle,  String? currentArtist,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _AudioState():
return $default(_that.status,_that.volume,_that.quality,_that.currentTitle,_that.currentArtist,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PlaybackStatus status,  double volume,  int quality,  String? currentTitle,  String? currentArtist,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _AudioState() when $default != null:
return $default(_that.status,_that.volume,_that.quality,_that.currentTitle,_that.currentArtist,_that.errorMessage);case _:
  return null;
...
class _AudioState implements AudioState {
  const _AudioState({this.status = PlaybackStatus.initial, this.volume = 0.5, this.quality = 128, this.currentTitle, this.currentArtist, this.errorMessage});
...
/// Create a copy of AudioState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? volume = null,Object? quality = null,Object? currentTitle = freezed,Object? currentArtist = freezed,Object? errorMessage = freezed,}) {
